...
export const metadata: Metadata = {
  ...
  description: "Consultoría ISO, capacitación empresarial y mejora de procesos en Panamá y Latinoamérica.",
  icons: { icon: "/favicon.svg", shortcut: "/favicon.svg" },
  openGraph: {
    title: "EQP Consulting | Sistemas que impulsan resultados",
    description: "Consultoría ISO, capacitación y mejora continua.",
    images: [{ url: "/og.png", width: 1200, height: 630, alt: "EQP Consulting" }],
  },
